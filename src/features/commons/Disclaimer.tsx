...
const Disclaimer = () => {
  ...
  return (
    <motion.div
      className="w-full bg-white px-6 py-5 mt-7 rounded-md flex flex-col overflow-hidden"
      animate={{ height: show ? "auto" : 65 }}
    ...
    >
      ...
      <div className="mt-3">
        <p>
          ...
          primary purpose of this beta release is to obtain feedback on software
          and product performance and the identification of defects.
        </p>
        <p className="mt-4">
          ...
          suitability or usability of this product, software, and/or its content
          in the beta version. fuse will not be liable for any loss, wehter
          direct or indirect, special or consequenntial, suffered by any party
          as a result of their use of the beta vestion, its content, and
          functionalities.
        </p>
        <p className="mt-4">
